...
impl ObjectType {
    ...
    pub fn priority(&self) -> i32 {
        match self {
            ...
            Self::StdStrings => 2,
            Self::SearchPath => 3,
            Self::Database | Self::DatabaseProperties => 4,
            Self::Schema => 5,
            Self::ProceduralLanguage => 6,
            Self::Collation => 7,
            Self::Transform => 8,
            Self::Extension => 9,
            Self::Type | Self::ShellType | Self::Domain => 10,
            Self::Cast => 11,
            Self::Function | Self::Procedure => 12,
            Self::Aggregate => 13,
            Self::AccessMethod => 14,
            Self::Operator => 15,
            Self::OperatorFamily | Self::OperatorClass => 16,
            Self::Conversion => 17,
            Self::TextSearchParser => 18,
            Self::TextSearchTemplate => 19,
            Self::TextSearchDictionary => 20,
            Self::TextSearchConfiguration => 21,
            Self::ForeignDataWrapper => 22,
            Self::ForeignServer | Self::Server => 23,
            Self::ForeignTable | Self::Table | Self::Sequence | Self::View => 24,
            Self::TableAttach => 25,
            Self::Default | Self::SequenceOwnedBy => 26,
            Self::TableData => 27,
            Self::SequenceSet => 28,
            Self::LargeObject | Self::Blob | Self::BlobMetadata | Self::PgLargeobjectMetadata => 29,
            Self::Blobs | Self::PgLargeobject => 30,
            Self::StatisticsData => 31,
            Self::CheckConstraint | Self::Constraint => 32,
            Self::Index => 33,
            Self::IndexAttach => 34,
            Self::Statistics => 35,
            Self::Rule => 36,
            Self::Trigger => 37,
            Self::FkConstraint => 38,
            Self::Policy | Self::RowSecurity => 39,
            Self::Publication => 40,
            Self::PublicationTable => 41,
            Self::PublicationTablesInSchema => 42,
            Self::Subscription => 43,
            Self::SubscriptionTable => 44,
            Self::DefaultAcl => 45,
            Self::MaterializedView => 46,
